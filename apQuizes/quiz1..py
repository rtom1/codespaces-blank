...
A way of storing information in a program

# 2. Name three (3) operators we've learned about in class and describe 
# a situation where you would use each one. 
Arithmetic and you would use it on an online bank program 
Comparison: x == y
Activity: Multiply 10 and 3, store result in a variable, and print the result
...
the process of creating instructions that computers then interpret and follow
